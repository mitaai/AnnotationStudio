    ...
    <>
      ...
      <style jsx global>
        {`
          ...
          [data-testid="slate-toolbar"] .btn-outline-secondary {
            color: #6c757d !important;
          }

          [data-testid="slate-toolbar"] .btn-outline-secondary.active, [data-testid="slate-toolbar"] .btn-outline-secondary:focus, [data-testid="slate-toolbar"] .btn-outline-secondary:hover {
