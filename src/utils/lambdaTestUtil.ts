...
import nextConnect, { NextConnect, Middleware as NextConnectMiddleware, } from 'next-connect';
import {
  apiResolver,
  getQueryParser,
...
interface UrlArguments {
   ...
   */
  middleware?: NextConnectMiddleware<any, any> | NextConnectMiddleware<any, any>[];
  /**
